...
const getImagePsinet = async () => {

  const filePath = path.join(__dirname, '..', '..', 'public', 'images', 'logo_psinet.png')

  try {
    let image = await fs.readFile(filePath, 'base64');
...
const getImageCodelco = async () => {

  const filePath = path.join(__dirname, '..', '..', 'public', 'images', 'logo_codelco.png')
...
const jsonToHtmlValeSalida = async (json, idTicket) => {
  let imagePsinet = await getImagePsinet()
  let imageCodelco = await getImageCodelco()
  ...
  let html = '<html>' +
    ...
    '<img class="imgLogoPsinet " alt="Logo Psinet" width="130" 		src="data:image/png;base64, '+imagePsinet+'">' +

    '<div class="titulo"><h1>VALE SALIDA DE MATERIALES</h1></div>' +

    '<img class="imgLogoCodelco" alt="Logo Codelco" width="130" 		src="data:image/png;base64, '+imageCodelco+'">' +
        ...
        <tr>
          ...
          <td class="container">
            <div class="content">
              ...
              <!-- START CENTERED WHITE CONTAINER -->
              <span class="preheader">Olvido de Contraseña </span>
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
  
                <!-- START MAIN CONTENT AREA -->
                <tr>
                  <td class="wrapper">
                    <p><b>Hola ${user[0].nombre} !<b></p>
                    <p>Realizaste una solicitud por olvido de contraseña, favor haz click en el siguiente link para continuar.</p>
                    <a  style="font-size: 10px;" href="https://bodega.ssll-dsal.cl/changepass?id=${user[0].idusuario}&email=${user[0].correo}&token=${user[0].pass}">https://bodega.ssll-dsal.cl/changepass?id=${user[0].idusuario}&email=${user[0].correo}&token=${user[0].pass}</a>
                    <br>
...
const emailTicketAbierto = (idTicket, responsableRetira, responsableCorreo) => {
  const html = `<!doctype html>
  <html lang="en">
    <head>
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <tr>
          ...
          <td class="container">
            <div class="content">
              ...
              <!-- START CENTERED WHITE CONTAINER -->
              <span class="preheader">Ticket Pendiente </span>
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
            ...
            <div class="content">
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                ...
                <tr>
                  <td class="wrapper">
                    <p><b>Hola !<b></p>
                    <p>Cambio de contraseña realizado con exito.</p>
...
module.exports = {
  jsonToHtmlValeSalida,
  emailValeSalida,
  jsonToHtmlValeEntrada,
  emailValeEntrada,
  emailForgetPass,
  emailNewPass,
  emailTicketAbierto
